    ...
    <div className="relative w-full max-w-[1400px] mx-auto px-[35px]">
      <div className="w-full flex items-center justify-between py-[23px]">
        ...
        <nav className="relative flex items-center gap-[45px]">
          ...
          <button className="flex items-center gap-[12px] py-[12px] px-[22px] bg-white15 border border-white rounded-[12px] group hover:border-pink transition-all">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
            ...
            >
              <path className="group-hover:stroke-pink transition-all"
            ...
            <p className="text-sm font-ceraMedium text-white group-hover:text-pink transition-all">playlist</p>
          </button>
        </nav>
      </div>
    </div>
