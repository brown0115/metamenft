...
function getCard() {
  return (
    <div className="flex flex-col gap-[12px] w-full max-w-[160px]">
      <div className="relative w-full bg-white15 border border-pink60 rounded-[4px] px-[20px] flex justify-end">
        <div className="absolute left-[12px] w-[50px] rounded-[4px] h-[69px] bottom-[10px] overflow-hidden">
          <img className="w-full h-full object-cover" src={Card} alt="" />
        </div>
        <p className="text-xl text-pink font-ceraBlack uppercase mb-[18px]">
          card
        </p>
      </div>
      <div className="w-full flex justify-between">
        <a href="#" className="hover:scale-[1.2] transition-all group flex items-center">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
          ...
          >
            <path className="group-hover:fill-pink transition-all"
